...
const Home = () => {
    ...
    return (
        ...
        {
            services.slice(0,4).map(service=><PopularService key={service._id} service={service}></PopularService>)
           }   </div> 
              <div className="w-full" id="ShowAll">
            
          <Link to={'/services'} className="  flex mx-auto w-fit  justify-center  my-10  ">
          <Button>
          Show All
