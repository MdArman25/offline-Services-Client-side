...
const ServiceDetails = () => {
  ...
  return (
    <div className="card p-10 border-2 max-w-screen-xl mx-auto">
      <Helmet>
        <title> Service Swap || SERVICE DETAILS</title>
      </Helmet>
      <img
        className=" relative h-96 object-cover w-11/12 mx-auto"
      ...
      <div className="p-6 sm:p-12 dark:bg-gray-900 dark:text-gray-100">
        <div className="grid grid-cols-2 justify-between items-center">
          <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
            <img
              src={serviceData?.user_image}
              alt=""
              className="object-cover h-1/4 w-5/12 md:left-20 md:w-3/12 absolute top-80 md:top-64 self-center flex-shrink-0  border-2  md:justify-self-start dark:bg-gray-500 dark:border-gray-700"
            />
            <div className="flex flex-col">
              <h4 className="text-lg font-semibold -mt-20 text-center md:text-left">
                {serviceData?.user_name}
              </h4>
              <p className="dark:text-gray-400">{serviceData?.service_area}</p>
          ...
          <div>
            <h2 className="text-xl  font-bold ">{serviceData?.service_name}</h2>
            <span className="block pb-2 text-xl font-semibold dark:text-gray-400">
      ...
      <div className="flex justify-between items-center gap-10">
        ...
        <Modal show={openModal} size="3xl" onClose={onCloseModal} popup>
          <Modal.Header />
          <Modal.Body>
            <div className="bg-[#F4F3F0] px-5 max-w-screen-xl rounded-xl mx-auto mt-30">
              <h2 className="text-3xl font-extrabold my-6">Booking Now</h2>
              <form onSubmit={SubmiteModule} className="">
                <div className="md:flex mb-4 gap-5 ">
                  ...
                  <div className="form-control md:w-1/2">
                    ...
                    <label className="input-group">
                      <input
                        readOnly
                        type="url"
                        defaultValue={serviceData?.service_image}
                        name="img"
                  ...
                  <div className="form-control md:w-1/2">
                    ...
                    <label className="input-group">
                      <input
                        readOnly
                        type="text"
                        defaultValue={serviceData?.provider_email}
                        name="name"
                ...
                <div className="flex justify-center">
                  <input
                    type="submit"
                    value="Add Book"
                    className="btn btn-outline btn-success w-6/12 border-2 hover:cursor-pointer"
                  />
                </div>
              </form>
            </div>
