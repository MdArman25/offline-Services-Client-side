// import client1 from '../assets/Images/Client/handsome-male-client-signing-document-meeting-with-real-estate-agent_109710-1809.jpg';
// import client2 from '../assets/Images/Client/portrait-beautiful-woman-glasses-with-folder-her-hands-work-dark-background_219728-1784.jpg';
// import client3 from '../assets/Images/Client/young-bearded-man-with-striped-shirt_273609-5677.jpg';
// import client14 from '../assets/Images/Client/young-beautiful-woman-singer-stage-singing-into-microphone.jpg';
...
//                 <div className="text-sm text-gray-500 dark:text-gray-400">Sam (Wedding)
// </div>
//             </div>
//         </figcaption>    
//     </figure>
...
//                 <div className="text-sm text-gray-500 dark:text-gray-400">Fisher's Brewery (Private event)</div>
//             </div>
//         </figcaption>    
//     </figure>
...
//             <div className="space-y-0.5 font-medium dark:text-white text-left">
//                 <div>Jese Leos</div>
//                 <div className="text-sm text-gray-500 dark:text-gray-400">Adam & Chloe (Wedding - Cornwall)</div>
//             </div>
//         </figcaption>    
//     </figure>
...
//         </blockquote>
//         <figcaption className="flex items-center justify-center space-x-3">
//             <img className="rounded-full w-20 h-20" src={client14} alt="profile picture"/>
//             <div className="space-y-0.5 font-medium dark:text-white text-left">
//                 <div>Joseph McFall</div>
//                 <div className="text-sm text-gray-500 dark:text-gray-400">Haggis McLeod, Glastonbury Head-Programmer (Glastonbury Music Festival)</div>
//             </div>
//         </figcaption>    
//     </figure>
// </div>
