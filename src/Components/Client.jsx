...
import client2 from '../assets/Client/portrait-handsome-young-man-with-crossed-arms.jpg';
import client3 from '../assets/Client/young-bearded-man-with-striped-shirt_273609-5677.jpg';
import client14 from '../assets/Client/young-beautiful-woman-singer-stage-singing-into-microphone.jpg';
...
const Client = () => {
    ...
    <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
        <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            ...
            <p className="my-4">A huge thank you to John who sang so beautifully at our Services on Saturday 14th August. John is such a talented vocalist and was loved by all our guest. If your thinking of booking a vocalist for your Services then John’s the man absolutely breathtaking and got everyone dancing. I’m just gutted we can’t do it all again.</p>
        </blockquote>
        <figcaption className="flex items-center justify-center space-x-3">
            <img className="rounded-full w-20 h-20" src={client1} alt="profile picture"/>
            <div className="space-y-0.5 font-medium dark:text-white text-left">
                <div>Bonnie Green</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Sam (Services)
</div>
        </div>
        </figcaption>    
    </figure>
    <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-tr-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <figcaption className="flex items-center justify-center space-x-3">
            ...
            <div className="space-y-0.5 font-medium dark:text-white text-left">
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400">Fisher's Brewery ( Service)</div>
            </div>
        </figcaption>    
    </figure>
    <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-bl-lg md:border-b-0 md:border-r dark:bg-gray-800 dark:border-gray-700">
        ...
        <figcaption className="flex items-center justify-center space-x-3">
            ...
            <div className="space-y-0.5 font-medium dark:text-white text-left">
                <div>Jese Leos</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Adam & Chloe (Services - Cornwall)</div>
            </div>
        </figcaption>    
    </figure>
